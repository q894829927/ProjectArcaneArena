...
- `/Game/ProjectArcaneArena/Systems/Inventory/Data/DA_HealthPotion`
- `/Game/ProjectArcaneArena/Systems/Inventory/Data/DA_EnergyPotion`
- `/Game/ProjectArcaneArena/Systems/Inventory/Effects/GE_Cooldown_ItemConsumable`
- `/Game/ProjectArcaneArena/Systems/Inventory/Pickups/BP_HealthPotionPickup`
- `/Game/ProjectArcaneArena/Systems/Inventory/Pickups/BP_EnergyPotionPickup`
- `/Game/ProjectArcaneArena/UI/Inventory/WBP_Inventory`
- `/Game/ProjectArcaneArena/UI/Inventory/WBP_InventorySlot`
...
`/Game/ProjectArcaneArena/Core/Controllers/BP_ArenaPlayerController.InventoryWidgetClass`。
...
- `/Game/ProjectArcaneArena/Systems/Inventory` 与 `/Game/ProjectArcaneArena/UI/Inventory` 下不存在同名 `_1/_2` 资产。
