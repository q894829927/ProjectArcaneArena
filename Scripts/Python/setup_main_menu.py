...
MENU_DIRECTORY = "/Game/ProjectArcaneArena/UI/MainMenu"
...
GAMEPLAY_MAP_PACKAGE = "/Game/ProjectArcaneArena/World/Maps/Lvl_Arena"
...
def main():
    ...
    unreal.log(
        "Main menu setup completed: /Game/ProjectArcaneArena/UI/MainMenu/Lvl_MainMenu is now "
