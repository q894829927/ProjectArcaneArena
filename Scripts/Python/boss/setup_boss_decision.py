...
AI_DIRECTORY = "/Game/ProjectArcaneArena/Characters/Boss/AI"
...
def _require_editor_type(type_name):
    ...
    if editor_type is None:
        raise RuntimeError(
            ...
            "BT_ArenaBoss under /Game/ProjectArcaneArena/Characters/Boss/AI manually, then follow this folder's README."
        )
    return editor_type
...
def main():
    ...
    unreal.log_warning(
        ...
        "/Game/ProjectArcaneArena/Characters/Boss/AI/BT_ArenaBoss and build the fixed stage-two-A graph described "
