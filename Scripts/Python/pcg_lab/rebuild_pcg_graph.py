...
NEW_GRAPH_PATH = "/Game/ProjectArcaneArena/Dev/Tests/PCG/PCG_Decor_Lab_Minimal"
...
def _create_fresh_graph():
    ...
    graph = asset_tools.create_asset(
        "PCG_Decor_Lab_Minimal", "/Game/ProjectArcaneArena/Dev/Tests/PCG", unreal.PCGGraph, factory
    )
    if graph is None:
