...
UPGRADE_CONFIGS = [
    {
        ...
        "destination_path": "/Game/ProjectArcaneArena/Systems/Upgrades/Data",
    ...
    },
    {
        ...
        "display_name": "雷暴增幅",
        "description": "闪电风暴伤害提高 16%，最多叠加 3 层",
        "rarity": "COMMON",
    ...
    },
    {
        ...
        "max_stacks": 1,
        "stackable": False,
        "icon_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_Overload_Icon",
        "icon_template_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_LightningStormShocked_Icon",
        "granted_gameplay_effect_path": None,
        "granted_ability_path": "/Game/ProjectArcaneArena/Combat/GAS/Abilities/GA_Overload",
    },
    {
        ...
        "max_stacks": 3,
        "stackable": True,
        "icon_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_EnergyOnKill_Icon",
        "icon_template_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_LightningStormShocked_Icon",
        "granted_gameplay_effect_path": None,
        "granted_ability_path": "/Game/ProjectArcaneArena/Combat/GAS/Abilities/GA_EnergyOnKill",
    },
    {
        ...
        "max_stacks": 5,
        "stackable": True,
        "icon_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_CritChance_Icon",
        "icon_template_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_AttackPower_Icon",
        "granted_gameplay_effect_path": "/Game/ProjectArcaneArena/Combat/GAS/Effects/Upgrades/GE_Upgrade_CritChance",
        "granted_ability_path": None,
    },
    {
        ...
        "max_stacks": 3,
        "stackable": True,
        "icon_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_EnergyOnCrit_Icon",
        "icon_template_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_EnergyOnKill_Icon",
        "granted_gameplay_effect_path": None,
        "granted_ability_path": "/Game/ProjectArcaneArena/Combat/GAS/Abilities/GA_EnergyOnCrit",
    },
    {
        "asset_name": "DA_Upgrade_EnergyOnAbilityCast",
        "destination_path": "/Game/ProjectArcaneArena/Systems/Upgrades/Data",
        "upgrade_id": "Upgrade.Trigger.EnergyOnAbilityCast",
        "display_name": "奥术回流",
        "description": "成功施放消耗能量的技能后恢复 5 点能量，最多叠加 3 层",
        "rarity": "RARE",
        "upgrade_tags": ["Upgrade.Trigger.EnergyOnAbilityCast"],
        "required_tags": [],
        "blocked_tags": [],
        "target_ability_tag": "Ability.Passive.EnergyOnAbilityCast",
        "trigger_event_tag": "Trigger.OnAbilityCast",
        "damage_type_tag": None,
        "numeric_value": 5.0,
        "max_stacks": 3,
        "stackable": True,
        "icon_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_EnergyOnAbilityCast_Icon",
        "icon_template_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_EnergyOnCrit_Icon",
        "granted_gameplay_effect_path": None,
        "granted_ability_path": "/Game/ProjectArcaneArena/Combat/GAS/Abilities/GA_EnergyOnAbilityCast",
    },
    {
        "asset_name": "DA_Upgrade_ShieldAmount",
        "destination_path": "/Game/ProjectArcaneArena/Systems/Upgrades/Data",
        "upgrade_id": "Upgrade.Shield.Amount",
        "display_name": "坚固屏障",
        "description": "护盾技能获得的护盾量提高 20%，最多叠加 3 层",
        "rarity": "COMMON",
        "upgrade_tags": ["Build.Shield", "Upgrade.Shield.Amount"],
        "required_tags": [],
        "blocked_tags": [],
        "target_ability_tag": "Ability.Shield",
        "trigger_event_tag": None,
        "damage_type_tag": None,
        "numeric_value": 0.20,
        "max_stacks": 3,
        "stackable": True,
        "icon_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_ShieldAmount_Icon",
        "icon_template_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_MaxHealth_Icon",
        "granted_gameplay_effect_path": None,
        "granted_ability_path": None,
    },
    {
        "asset_name": "DA_Upgrade_ShieldBreakBlast",
        "destination_path": "/Game/ProjectArcaneArena/Systems/Upgrades/Data",
        "upgrade_id": "Upgrade.Trigger.ShieldBreakBlast",
        "display_name": "破盾冲击",
        "description": "护盾被伤害击破时，对周围敌人造成基础伤害为 25 的物理爆发",
        "rarity": "RARE",
        "upgrade_tags": ["Build.Shield", "Upgrade.Trigger.ShieldBreakBlast"],
        "required_tags": ["Build.Shield"],
        "blocked_tags": [],
        "target_ability_tag": "Ability.Passive.ShieldBreakBlast",
        "trigger_event_tag": "Trigger.OnShieldBreak",
        "damage_type_tag": "Damage.Physical",
        "numeric_value": 25.0,
        "max_stacks": 1,
        "stackable": False,
        "icon_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_ShieldBreakBlast_Icon",
        "icon_template_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_Overload_Icon",
        "granted_gameplay_effect_path": None,
        "granted_ability_path": "/Game/ProjectArcaneArena/Combat/GAS/Abilities/GA_ShieldBreakBlast",
    },
    {
        "asset_name": "DA_Upgrade_DashCooldown",
        "destination_path": "/Game/ProjectArcaneArena/Systems/Upgrades/Data",
        "upgrade_id": "Upgrade.Dash.Cooldown",
        "display_name": "迅捷步伐",
        "description": "冲刺冷却时间缩短 15%，最多叠加 3 层",
        "rarity": "COMMON",
        "upgrade_tags": ["Build.Dash", "Upgrade.Dash.Cooldown"],
        "required_tags": [],
        "blocked_tags": [],
        "target_ability_tag": "Ability.Dash",
        "trigger_event_tag": None,
        "damage_type_tag": None,
        "numeric_value": 0.15,
        "max_stacks": 3,
        "stackable": True,
        "icon_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_DashCooldown_Icon",
        "icon_template_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_MoveSpeed_Icon",
        "granted_gameplay_effect_path": None,
        "granted_ability_path": None,
    },
    {
        "asset_name": "DA_Upgrade_DashLightningTrail",
        "destination_path": "/Game/ProjectArcaneArena/Systems/Upgrades/Data",
        "upgrade_id": "Upgrade.Dash.LightningTrail",
        "display_name": "雷霆余迹",
        "description": "冲刺结束后留下 2 秒闪电路径，每 0.5 秒造成 6 点基础闪电伤害",
        "rarity": "RARE",
        "upgrade_tags": ["Build.Dash", "Upgrade.Dash.LightningTrail"],
        "required_tags": ["Build.Dash"],
        "blocked_tags": [],
        "target_ability_tag": "Ability.Passive.DashLightningTrail",
        "trigger_event_tag": "Trigger.OnDashEnd",
        "damage_type_tag": "Damage.Lightning",
        "numeric_value": 6.0,
        "max_stacks": 1,
        "stackable": False,
        "icon_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_DashLightningTrail_Icon",
        "icon_template_path": "/Game/ProjectArcaneArena/UI/Upgrade/Icons/T_Upgrade_LightningStormShocked_Icon",
        "granted_gameplay_effect_path": None,
        "granted_ability_path": "/Game/ProjectArcaneArena/Combat/GAS/Abilities/GA_DashLightningTrail",
    },
]
