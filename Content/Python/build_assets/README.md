...
本目录集中管理 Fire/Lightning/Crit/Shield/Overload 构筑与事件触发升级使用的 Upgrade DataAsset、GameplayEffect/GameplayAbility Blueprint、持续/爆发/伤害数字 GameplayCue，以及 Ability/GameMode/原型波次资产连接。
