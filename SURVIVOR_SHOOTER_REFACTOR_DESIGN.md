...
| P3：Spatial Hash Collision | Partial | Enemy 注册、Spatial Hash Cell 查询、Previous→Current Swept Collision、HitCommand Buffer 与现有 GAS Damage Pipeline | 源码已实现；待编译/PIE 验证高速不穿透、单发单命中和多人 Source 归属 |
